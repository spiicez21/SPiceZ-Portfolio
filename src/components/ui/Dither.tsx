...
void mainImage(in vec4 inputColor, in vec2 uv, out vec4 outputColor) {
  // resolution is provided by postprocessing automatically? 
  // Actually Effect usually provides resolution uniform
...
function DitheredWaves({
    ...
    }), []); // Empty dep array, we update refs manually
    ...
    // Update uniforms via refs or frame
    ...
    useFrame(({ clock }) => {
        ...
        // Color check
        if (prevColor.current[0] !== waveColor[0] || prevColor.current[1] !== waveColor[1] || prevColor.current[2] !== waveColor[2]) {
